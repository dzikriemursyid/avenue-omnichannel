...
export function TeamManagement({ teams, currentUser, canCreateTeam, canDeleteTeam }: TeamManagementProps) {
            ...
            <Card key={team.id}>
              <CardHeader>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  {(hasPermission(currentUser.role, "manage_team") ||
                    (currentUser.role === "leader" && team.leader?.id === currentUser.id)) && (
