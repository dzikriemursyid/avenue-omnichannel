...
import { Send, Plus, Calendar, Users, TrendingUp, Play, Pause, MoreHorizontal, ExternalLink } from "lucide-react"
...
export default function CampaignOverview({ profile, campaigns }: CampaignOverviewProps) {
    const statusColors = {
        draft: "bg-gray-500",
