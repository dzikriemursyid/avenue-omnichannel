        ...
        <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-muted-foreground mb-6 text-center max-w-xs">
                {hasActiveFilters
                    ...
                    : 'Belum ada template WhatsApp yang tersedia.'}
            </p>
...
export default function TemplateList({ canManage = false }: TemplateListProps) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            // Show success message with additional info if template was from Twilio
